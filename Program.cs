...
namespace AppCrudLivro
{
    public class Program
    {
        private static string connectionString = "Server=localhost;Database=db_aulas_2024;Uid=gabi;Pwd=1234567;SslMode=none;";
        ...
        static void Main(string[] args)
        {
            while (true)
            {
                ...
                Console.WriteLine("2 - Alistar livros");
                Console.WriteLine("3 - Editar livro");
                Console.WriteLine("4 - Apagar livro");
                Console.WriteLine("5 - Sair");
                Console.Write("Escolha uma opção sobre:");
        ...
        {
            Console.Write("Coloque o título do livro:");
            string titulo = Console.ReadLine();
            Console.Write("Coloque o autor do livro:");
            string autor = Console.ReadLine();
            Console.Write("Coloque o ano de publicação do livro:");
            int ano_publicacao = int.Parse(Console.ReadLine());
            Console.Write("Coloque o gênero do livro:");
            string genero =Console.ReadLine();
            Console.Write("Coloque o número de páginas do livro:");
            int numero_paginas = int.Parse(Console.ReadLine());

            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                connection.Open();
                string query = "INSERT INTO livros (titulo,autor,ano_publicacao,genero,numero_paginas) VALUES(@titulo,@autor,@ano_publicacaoo,@genero,@numero_paginas)";
            ...
            Console.Write("Livro listado com sucesso!\n");
        }
        ...
        static void Listar()
        {
            ...
            {
                connection.Open();
                string query = "SELECT id, titulo, autor, ano_publicacao, genero, numero_paginas FROM livros";
                MySqlCommand cmd = new MySqlCommand(query, connection);
                using (MySqlDataReader reader = cmd.ExecuteReader())
                {
                    ...
                    {
                        Console.WriteLine("Não tem esse livro cadastrado");
                    }
                }
            }
        }
        static void Excluir()
        {
            Console.WriteLine("Coloque o Id do livro que deseja excluir:");
            ...
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                ...
                {
                    Console.WriteLine("Livro não achado.");
                }
            }
        }
        static void Editar()
        {
            Console.WriteLine("Coloque o Id do livro que deseja editar:");
            ...
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                ...
                using (MySqlDataReader reader = cmd.ExecuteReader())
                {
                    if (reader.Read())
                    {
                        Console.Write("Coloque o novo título do livro:");
                        string novo_titulo = Console.ReadLine();
                        Console.Write("Coloque o novo autor do livro:");
                        string novo_autor = Console.ReadLine();
                        Console.Write("Coloque o novo ano de publicação do livro:");
                        string novo_ano_publicacao =Console.ReadLine();
                        Console.Write("Coloque o novo gênero do livro:");
                        string novo_genero = Console.ReadLine();
                        Console.Write("Coloque o número de páginas do livro:");
                        string novo_numero_paginas =Console.ReadLine();
                        reader.Close();

                        string queryUpdate = "UPDATE livros SET titulo = @titulo, autor = @autor, ano_publicacao = @ano_publicacao,  genero = @genero,  numero_paginas = @numero_paginas WHERE Id = @Id";
                        ...
                        cmd.ExecuteNonQuery();
                        Console.WriteLine("Livro atualizado com êxito.");
                    }
                    else
                    {
